...
Revision ID: fac33a9cfe78
Revises: a4e82534dea3
Create Date: 2026-05-08 11:17:32.440329
...
revision: str = "fac33a9cfe78"
down_revision: Union[str, Sequence[str], None] = "a4e82534dea3"
...
def upgrade() -> None:
    ...
    op.add_column(
        "users",
        sa.Column(
            "role", sa.Enum("student", "teacher", "admin", name="role"), nullable=False
        ),
    )
